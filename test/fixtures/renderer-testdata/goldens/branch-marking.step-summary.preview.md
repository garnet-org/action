...
| --- | --- | --- |
| <code>kept.example.com [198.51.100.7] :443 tcp</code> | <code>systemd</code> → <code>Runner.Worker</code> → <code>bash</code> → <code>node (pid 5001)</code> | step: 2. Run tests |
| <code>fresh.example.net [198.51.100.8] :443 tcp</code> | <code>systemd</code> → <code>Runner.Worker</code> → <code>bash</code> → <code>node (pid 5001)</code> | step: 2. Run tests |
| <code>pypi.example.org [198.51.100.9] :443 tcp</code> | <code>systemd</code> → <code>…</code> → <code>bash</code> → <code>python3</code> → <code>pip (pid 5002)</code> | step: 3. Install tools |
