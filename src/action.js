...
async function discloseStartFailure(context, reason) {
    ...
    // The only warning a failed attach produces; the rest of the evidence is info-level.
    core.warning(
        `Garnet did not attach to this job — nothing was recorded. ` +
...
// The diagnostics the runner can still reach after a failed attach. Always
// collected (not debug-gated): the warning annotation says nothing was
// recorded, and this group is the only place the reason survives.
